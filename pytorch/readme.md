...
Вертикальная свертка 31x19 похоже нужна только в  НЧ диапазоне. Добавление аналогичного типа сверток (15х9) в ПЧ и ВЧ диапазоне не привели к улучшению работы сети.
